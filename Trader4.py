...
class Trader4(IStrategy):
    ...
    buy_sma15_32 = DecimalParameter(0.900, 1, default=0.935, decimals=3, space='buy', optimize=True)
    buy_cti_32 = DecimalParameter(-1, 1, default=0.51, decimals=2, space='buy', optimize=True)
    sell_fastx = IntParameter(50, 100, default=60, space='sell', optimize=True)

    sell_loss_cci = IntParameter(low=0, high=600, default=3, space='sell', optimize=True)
    sell_loss_cci_profit = DecimalParameter(-0.15, 0, default=-0.01, decimals=2, space='sell', optimize=True)
